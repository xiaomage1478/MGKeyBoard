...
@implementation MGKeyBoardCharView
...
- (void)setupShiftButton
{
    ...
    [self.shiftButton setBackgroundImage:[UIImage imageWithColor:kBackColor] forState:UIControlStateNormal];
    [self.shiftButton setBackgroundImage:[UIImage imageWithColor:kHightLightColor] forState:UIControlStateHighlighted];
    [self.shiftButton setImage:[UIImage imageNamed:@"keyboardSmall"] forState:UIControlStateNormal];
    [self.shiftButton setImage:[UIImage imageNamed:@"keyboardBig"] forState:UIControlStateSelected];
    self.shiftButton.frame = CGRectMake(space_x, thirRowY, offset_X2-space_x-space_x, btn_height);
    self.shiftButton.layer.masksToBounds = YES;
    self.shiftButton.layer.cornerRadius = kCornerRadius;
...
- (void)setupDeleteButton
{
    ...
    self.delButton.backgroundColor = kBackColor;
    self.delButton.layer.masksToBounds = YES;
    self.delButton.layer.cornerRadius = kCornerRadius;
    self.delButton.frame = CGRectMake(self.frame.size.width-self.shiftButton.frame.size.width-space_x, thirRowY, offset_X2-space_x-space_x, btn_height);
...
- (void)setupLastButton
{
    ...
    self.switch123Button.layer.masksToBounds = YES;
    self.switch123Button.layer.cornerRadius = kCornerRadius;
    [self.switch123Button setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [self.switch123Button setTitleColor:[UIColor blackColor] forState:UIControlStateHighlighted];
    self.switch123Button.titleLabel.font = [UIFont systemFontOfSize:16];
    [self.switch123Button setTitle:@"123" forState:UIControlStateNormal];
    //    self.switch123Button.backgroundColor = kBackColor;
    [self.switch123Button setBackgroundImage:[UIImage imageWithColor:kBackColor] forState:UIControlStateNormal];
    [self.switch123Button setBackgroundImage:[UIImage imageWithColor:kHightLightColor] forState:UIControlStateHighlighted];
    ...
    self.spaceButton.layer.cornerRadius = kCornerRadius;
    ...
    self.spaceButton.titleLabel.font = [UIFont systemFontOfSize:16];
    [self.spaceButton setTitle:@"空 格" forState:UIControlStateNormal];
    [self.spaceButton setBackgroundImage:[UIImage imageWithColor:kNormalColor] forState:UIControlStateNormal];
    [self.spaceButton setBackgroundImage:[UIImage imageWithColor:kHightLightColor] forState:UIControlStateHighlighted];
    ...
    [self.switchSymbolButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [self.switchSymbolButton setTitleColor:[UIColor blackColor] forState:UIControlStateHighlighted];
    self.switchSymbolButton.titleLabel.font = [UIFont systemFontOfSize:16];
    self.switchSymbolButton.layer.masksToBounds = YES;
    self.switchSymbolButton.layer.cornerRadius = kCornerRadius;
    [self.switchSymbolButton setTitle:@"#+=" forState:UIControlStateNormal];
    [self.switchSymbolButton setBackgroundImage:[UIImage imageWithColor:kBackColor] forState:UIControlStateNormal];
    [self.switchSymbolButton setBackgroundImage:[UIImage imageWithColor:kHightLightColor] forState:UIControlStateHighlighted];
