#
#  Be sure to run `pod spec lint MGKeyBoard.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "xiaomage"
  # s.authors            = { "xiaomage" => "martin1478@163.com" }
  # s.social_media_url   = "http://twitter.com/xiaomage"
